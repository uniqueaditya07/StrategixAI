...
- Workspace-based company assumptions and local company profiles
...
- `data/` contains sample and custom company profiles.
...
Current Status: Phase 7 complete - Executive Reporting & Export System implemented.
